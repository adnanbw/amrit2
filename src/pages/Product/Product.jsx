...
const Product = () => {
  ...
  function ProductDescription({ description }) {
    ...
    return <div className="desc" dangerouslySetInnerHTML={descriptionHtml} />;
  }
          ...
          return (
            <Grid item sm={4}>
              ...
              <img
                ...
                alt=""
                onClick={(e) => setSelectedImg(item.attributes.url)}
              />{" "}
            </Grid>
          );
        })}
          ...
          <div className="right">
            ...
            <div style={{ display: "flex", gap: 20 }}>
              ...
              >
                ...
                {data != null
                  ? Object.keys(data?.attributes?.Size?.size).map((size) => (
            ...
            <hr />
            <div className="info">
              <ProductDescription description={data?.attributes?.description} />
